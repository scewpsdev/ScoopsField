...
void ReloadGraphicsPipeline(GraphicsPipeline* pipeline)
{
	...
	createInfo.depth_stencil_state.enable_stencil_test = pipelineInfo->hasDepthTarget && pipelineInfo->stencilTest;
	createInfo.depth_stencil_state.front_stencil_state.compare_op = pipelineInfo->stencilCompareOp;
	createInfo.depth_stencil_state.front_stencil_state.pass_op = pipelineInfo->stencilPassOp;
	createInfo.depth_stencil_state.front_stencil_state.fail_op = SDL_GPU_STENCILOP_KEEP;
	createInfo.depth_stencil_state.front_stencil_state.depth_fail_op = SDL_GPU_STENCILOP_KEEP;
	createInfo.depth_stencil_state.back_stencil_state.compare_op = pipelineInfo->stencilCompareOp;
	createInfo.depth_stencil_state.back_stencil_state.pass_op = pipelineInfo->stencilPassOp;
	createInfo.depth_stencil_state.back_stencil_state.fail_op = SDL_GPU_STENCILOP_KEEP;
	createInfo.depth_stencil_state.back_stencil_state.depth_fail_op = SDL_GPU_STENCILOP_KEEP;
	createInfo.depth_stencil_state.compare_mask = pipelineInfo->stencilCompareMask;
	createInfo.depth_stencil_state.write_mask = pipelineInfo->stencilWriteMask;
