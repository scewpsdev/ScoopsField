...
struct PortalDrawData
{
	MeshDrawData drawData;
	int portalID;
	mat4 transform;
	mat4 destinationTransform;
	mat4 portalView;
};
...
#define BLOOM_STEPS 16
	...
	Shader* portalMaskShader;
	Shader* portalDepthResetShader;
	...
	GraphicsPipeline* portalMaskPipeline;
	GraphicsPipeline* portalDepthResetPipeline;
	GraphicsPipeline* geometryStencilPipeline;
...
#define MAX_PORTALS 16
	List<PortalDrawData, MAX_PORTALS> portals;
