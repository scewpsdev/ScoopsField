...
layout(set = 2, binding = 4) uniform sampler2D s_weatherMap;
layout(set = 2, binding = 5) uniform sampler3D s_cloudNoise;
layout(set = 2, binding = 6) uniform sampler3D s_cloudNoiseDetail;
